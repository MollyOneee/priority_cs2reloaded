...
- базовая third-person камера с настройкой дистанции;
- цветовая модуляция только статических world-материалов с исключением моделей, оружия, эффектов, неба и UI;
- отдельная вкладка Skins: выбор оружия, совместимого paint kit с цветом редкости, seed/wear/StatTrak и явная пересборка материала кнопкой Apply;
